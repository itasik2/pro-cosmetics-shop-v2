...
- Соблюдай современную русскую орфографию и пунктуацию: используй букву «ё» там, где она нужна, кавычки-ёлочки «», тире — и диапазоны с коротким тире, например 2–3.
- Никаких упоминаний ИИ/нейросетей.

Структура:
1) Вводный абзац (2–3 предложения), без заголовка.
2) Далее 6–9 смысловых разделов, каждый из которых содержит:
   - заголовок **...**
      ...
      return NextResponse.json(
        {
          ...
          message:
            "Закончилась квота OpenAI (429). Проверьте тариф, биллинг и лимиты в OpenAI Platform.",
        },
        { status: 429 },
      );
    }
