...
const STORE_ADVANTAGES = [
  {
    ...
    text: "Средства собраны под понятные задачи: очищение, увлажнение, восстановление, антивозрастной уход и поддержка проблемной кожи.",
  },
  {
...
export async function generateMetadata() {
  ...
  return {
    title: `Купить профессиональную косметику в Казахстане | ${SITE_BRAND}`,
