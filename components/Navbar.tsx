      ...
      <header className="sticky top-0 z-50 border-b border-[var(--color-border)] bg-white/95 backdrop-blur">
        ...
        <div className="container flex min-h-[76px] items-center justify-between gap-4 py-3">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/checkout"
              className="relative inline-flex min-h-11 items-center justify-center rounded-xl border border-[var(--color-border)] bg-white px-3 text-sm font-semibold text-gray-800 hover:border-gray-400"
            ...
            <button
              type="button"
              className="inline-flex min-h-11 items-center justify-center rounded-xl bg-[var(--color-primary)] px-3 text-sm font-semibold text-white lg:hidden"
